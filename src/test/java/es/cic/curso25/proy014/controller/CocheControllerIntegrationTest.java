...
//     @Test
//     void testLeerVehiculo() throws Exception {

//         LOGGER.info("[TEST] Iniciando testLeerVehiculo");
...
//     Vehiculo verificoVehiculo = vehiculoRepository.findById(2L).get();
...
//     boolean existe = vehiculoRepository.findAll().stream()
//                 .anyMatch(vehiculoTest -> "TEST1234".equals(vehiculoTest.getMatricula()) && vehiculoTest.getPlaza().getNumPlaza().equals(2L));
...
//     Vehiculo vehiculoActualizado = vehiculoRepository.findById(1L).orElseThrow();
...
//     boolean existe = vehiculoRepository.findAll().stream()
//                 .anyMatch(vehiculoTest -> "NUEVO123".equals(vehiculoTest.getMatricula()) && vehiculoTest.getPlaza().getNumPlaza().equals(1L));
